...
* The IOTA foundations response to the [MIT-DCI report](https://github.com/mit-dci/tangled-curl/blob/master/vuln-iota.md), specifically Come-from-Beyond’s attitude (that he himself will occasionally categorize as trolling). As recently as saying they have "lawyers working on that already" calling their report fraud. I would rather just post this here rather than dealing with that.
